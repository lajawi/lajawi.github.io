...
export function SocialLink({ social }: { social: Social }) {
    return (
        <Link href={social.href} target="_blank" title={social.title} className="bg-(--muted) hover:bg-white transition-colors w-10 h-10 m-4 select-none cursor-pointer" style={{
